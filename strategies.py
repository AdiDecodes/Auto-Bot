...
#         time_now = datetime.now()
#         print(time_now.strftime("Current Time - " + "%d/%m/%Y - %H:%M:%S"))
#         signal = checkmsg()
#         print("\n============================================\n")

#         if (signal == "DOWN"):
#             pointer_click(SELL)
#             print("SIGNAL RECEIVED - DOWN")
#         elif (signal == "UP"):
#             pointer_click(BUY)
#             print("SIGNAL RECEIVED - UP")
...
# 30-SECOND CHART
def golden_moment_strategy(balance, balance_tp, balance_sl, op_list, m_max,
                           m_switching):
    ...
    while True:
        ...
        if (datetime.now() - time_now).seconds == 1:
            ...
            if time_now.strftime("%S") == '30':
                ...
                if (rsi_30 > 80
                        and stochastic_30 > 80) or (rsi_30 < 20
                                                    and stochastic_30 < 20):
                    ...
                    if rsi_30 > 80 and stochastic_30 > 80:
                        ...
                        if rsi_00 < 80 and rsi_00 > 50 and stochastic_00 < 80 and stochastic_00 > 50:
                            ...
                            var_static = [signal, op_list, m_max, m_switching]
                            var_return = [
                                balance, trades_list, martingales_list
                            ]
                            balance, trades_list, martingales_list = trade(
                                var_static, var_return)

                            # save data to csv file
                            set_csv_data(data, balance, trades_list,
                                         martingales_list)
            ...
            if balance >= balance_tp or balance <= balance_sl or (
                    m_largest >= m_max and m_max != 0):
                end_program()
